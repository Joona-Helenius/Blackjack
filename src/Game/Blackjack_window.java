...
/**
 * Blackjack_window luokka toteuttaa peliin tarvittavan GUI:n eli graafisen käyttöliittymän.
 * Luokka käyttää Java Swingiä tarvittavien asioiden näyttämiseen, kuten pöytä, kortit yms.
 * Blackjack_window on luotu käyttäen Eclipsen lisäosaa nimeltä WindowBuilder. 
 * Ikkuna ja sen väritys toteutetaan JFramella, korttien kuvat JLabelien ja JPanelien
...
public class Blackjack_window {
	...
	/**
     * Main metodi käynnistää itse pelin.
     * @param args jätetään tyhjäksi.
     */
	...
	/**
     * initialize() -metodi luo kaiken tarvittavan pelin grafiikan yms. pyörittämiseen.
     */
	...
	public void actionPerformed(ActionEvent e) {
		...
		tempCard.repaint();
		printCard(100, 60, dealer.getCardAtIndex(dealer.hand.size()-1));
		...
		PlayerHandValue = new JTextArea("Player Hand Value:");
		...
		DealerHandValue = new JTextArea("Dealer Hand Value:");
	...
	public void actionPerformed(ActionEvent e) {
		...
		/**
	     * printCard()-metodi saa parametrikseen kortin x ja y position pikseleinä sekä itse
